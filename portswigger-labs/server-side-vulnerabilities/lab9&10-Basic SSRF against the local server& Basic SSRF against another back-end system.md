...
1. 根据[lab7](https://github.com/Naclarb/web-security-learning/blob/main/portswigger-labs/server-side-vulnerabilities/lab7-Username%20enumeration%20via%20different%20responses.md))学习到的Brute-forcing, 可以直接将192.168.0.X最后的octet进行枚举，仅需要highlight最后一个octet 将1-255paste进payload(type simple list)
