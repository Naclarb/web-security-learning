...
1. 根据[lab7](lab7-Username enumeration via different responses)学习到的Brute-forcing, 可以直接将192.168.0.X最后的octet进行枚举，仅需要highlight最后一个octet 将1-255paste进payload(type simple list)
